...
parser.add_argument("--k1", type=int, default=9,
                    help="intra_modal neighbor")
parser.add_argument("--k2", type=int, default=10,
                    help="help='inra_modal neighbor'") #40
parser.add_argument("--k3", type=int, default=10,
                    help="inter_modal neighbor")
parser.add_argument("--batch_size", type=int, default=128)  # 128
parser.add_argument("--lr_g", type=float, default=5e-4,  # 1e-4
                    help="adam: learning rate for G")
parser.add_argument("--lr_m", type=float, default=1e-4,  # 1e-4
                    help="adam: learning rate for model")
parser.add_argument("--lr_ae", type=float, default=1e-5,  # 1e-4
...
parser.add_argument("--lamda2", type=float, default=0.01,  # 1.0
...
parser.add_argument("--pretrain", type=str, default='load_all',
...
parser.add_argument('--img_cptpath', type=str, default='cpt/wikipedia_img_pretrain_checkpt.pkl',
                    help="path to load img AE checkpoint")
parser.add_argument('--txt_cptpath', type=str, default='cpt/wikipedia_txt_pretrain_checkpt.pkl',
                    help="path to load txt AE checkpoint")
parser.add_argument('--dm2c_cptpath', type=str, default='cpt/wikipedia_checkpt.pkl',
